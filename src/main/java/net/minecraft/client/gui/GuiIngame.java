...
public class GuiIngame extends Gui {
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_) {
        ...
        if (i > 0) {
            ...
            if (k > 0) drawTexturedModalRect(p_175176_2_, l, 0, 69, k, 5);
        }
    ...
    private void renderPlayerStats(ScaledResolution p_180477_1_) {
        ...
        if (mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            for (int i3 = 0; i3 < 10; ++i3) {
                if (k2 > 0) {
                    int j3 = i1 + i3 * 8;
                    if (i3 * 2 + 1 < k2) drawTexturedModalRect(j3, j2, 34, 9, 9, 9);
                    if (i3 * 2 + 1 == k2) drawTexturedModalRect(j3, j2, 25, 9, 9, 9);
                    if (i3 * 2 + 1 > k2) drawTexturedModalRect(j3, j2, 16, 9, 9, 9);
                }
            }
            ...
            for (int i6 = MathHelper.ceiling_float_int((f + f1) / 2.0F) - 1; i6 >= 0; --i6) {
                ...
                if (entityplayer.isPotionActive(Potion.poison)) j6 += 36; else if (entityplayer.isPotionActive(Potion.wither)) { j6 += 72; }
                ...
                if (flag) {
                    if (i6 * 2 + 1 < j) drawTexturedModalRect(i4, j4, j6 + 54, 9 * k4, 9, 9);

                    if (i6 * 2 + 1 == j) drawTexturedModalRect(i4, j4, j6 + 63, 9 * k4, 9, 9);
                }

                if (f2 > 0.0F) {
                    if (f2 == f1 && f1 % 2.0F == 1.0F) drawTexturedModalRect(i4, j4, j6 + 153, 9 * k4, 9, 9); else drawTexturedModalRect(i4, j4, j6 + 144, 9 * k4, 9, 9);
                    f2 -= 2.0F;
                } else {
                    if (i6 * 2 + 1 < i) drawTexturedModalRect(i4, j4, j6 + 36, 9 * k4, 9, 9);
                    if (i6 * 2 + 1 == i) drawTexturedModalRect(i4, j4, j6 + 45, 9 * k4, 9, 9);
                }
            }
            ...
            if (entity == null) {
                ...
                for (int k9 = 0; k8 > 0; k9 += 20) {
                    ...
                    for (int i5 = 0; i5 < l4; ++i5) {
                        ...
                        if (i5 * 2 + 1 + k9 < j7) drawTexturedModalRect(l5, j9, j5 + 36, 9, 9, 9);
                        if (i5 * 2 + 1 + k9 == j7) drawTexturedModalRect(l5, j9, j5 + 45, 9, 9, 9);
                    }
            ...
            if (entityplayer.isInsideOfMaterial(Material.water)) {
                ...
                for (int l8 = 0; l8 < k7 + i8; ++l8) if (l8 < k7) drawTexturedModalRect(j1 - l8 * 8 - 9, j2, 16, 18, 9, 9); else drawTexturedModalRect(j1 - l8 * 8 - 9, j2, 25, 18, 9, 9);
            }
