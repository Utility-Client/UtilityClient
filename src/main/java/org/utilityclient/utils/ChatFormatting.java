...
public enum ChatFormatting {
    ...
    private static final Pattern STRIP_FORMATTING_PATTERN = Pattern.compile("(?i)" + PREFIX_CODE + "[0-9A-FK-OR]");
    ...
    public static Enum<ChatFormatting> getByName(String name) {
    ...
    public static Collection<String> getNames(boolean getColors, boolean getFormats) {
        ...
        for (ChatFormatting format : var3)
    ...
    static {
        ...
        for (ChatFormatting format : var0) {
