...
public class DebugScreen extends GuiScreen {
    public DebugScreen() {
        ...
        add(new GuiContainer(2, 2, 512, 512, Lists.newArrayList(
            new GuiLabel("Hello world <3", 2, 2, Color.SnowWhite.color, false),
            new GuiHyperlink("Click me", () -> System.out.println("You clicked me!"), 2, 12, Color.SnowWhite.color, false),
            new GuiHeader("Header", 2, 24, Color.SnowWhite.color, false),
